...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation(libs.desktop) // Use the latest version
            implementation(libs.javafx.controls) // Add JavaFX controls
...
android {
    namespace = "org.luigui.descuentotemporal"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "org.luigui.descuentotemporal"
